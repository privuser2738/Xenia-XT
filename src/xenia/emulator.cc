...
X_STATUS Emulator::CloseTitle() {
  // CloseTitle is now just an alias for TerminateTitle
  // Full cleanup (kernel state reset, device unregistration) happens
  // automatically when LaunchPath is called for a new game
